...
import com.edutech.rgusuario.event.UsuarioEventPublisher;
...
public class UsuarioService {
    ...
    //Conexion con MS Gestion de cursos
    @Autowired
    ...
    public Usuario crearUsuario(Usuario usuario){
        ...
        //Verirfica si el usuario guardado tiene rol INSTRUCTOR
        boolean esInstructor = usuarioGuardado.getRoles().stream()
            .anyMatch(rol -> rol.getNombre().equalsIgnoreCase("INSTRUCTOR"));

        if (esInstructor) {
            usuarioEventPublisher.publicarUsuarioInstructorCreado(usuarioGuardado);
        }
