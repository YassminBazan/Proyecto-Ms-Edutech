...
public class CursoController {
    ...
    //AÑADIDO PARA CONECTAR CON MS GESTION DE CLASES

    @GetMapping("/{id}/detalle")
    public ResponseEntity<CursoConClasesDTO> obtenerCursoConClases(@PathVariable Long id) {
        CursoConClasesDTO curso = cursoService.obtenerCursoConClases(id);
